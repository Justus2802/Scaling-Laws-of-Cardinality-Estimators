...
Output is the **108-value feature dict** (the A/B/C/D/F subset of a measured
...
# Canonical 108-key order (A/B/C/D/F; Block E excluded), in the same order as
...
class SignatureSampler(ABC):
    ...
    def sample(self, seed: int | None = None) -> dict[str, float]:
        """Sample a full reduced signature as a 108-key feature dict.

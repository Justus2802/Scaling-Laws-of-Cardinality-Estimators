# Proposal: A Reduced, Non-Over-Determined Generative Signature

Status: **proposal only — no implementation.** Companion to
[signature_observations.md](signature_observations.md) (referred to below as "the
notes").
...
[generation_algorithm_fit.md](generation_algorithm_fit.md) for the best-effort gaps.

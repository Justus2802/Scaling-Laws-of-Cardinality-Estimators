...
[signature_redesign.md](signature_redesign.md). **Integration mode: coexisting module**
...
[signature_redesign.md](signature_redesign.md#derivability-criterion--what-may-actually-be-dropped).

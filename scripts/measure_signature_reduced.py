...
signature (Blocks A, B, C, D, F). By default writes a ``signature/`` directory
**next to the graph file**, matching the ``data/graphs/<name>/`` corpus layout
(so ``data/graphs/aids/AIDS.nt`` → ``data/graphs/aids/signature/``). Override
with ``--output-dir``.
"""
